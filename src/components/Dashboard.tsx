...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6 auto-animate">
      {/* Navigation Tabs */}
      <div className="bg-white dark:bg-slate-800 oled:bg-black emerald:bg-[#0f1f18] space:bg-[#2c2c2e] nova:bg-[#0f172a] navy:bg-[#0f172a] coral:bg-white/90 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 oled:border-gray-900 emerald:border-emerald-700 space:border-zinc-600 nova:border-sky-800 navy:border-blue-900 coral:border-pink-200 p-1 transition-all-fast auto-animate">
      ...
      {activeTab === "transactions" && (
        <div className="space-y-6 auto-animate">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 oled:text-white emerald:text-emerald-100 space:text-zinc-100 nova:text-sky-100 transition-all-fast">Transactions</h2>
      ...
      {activeTab === "budgets" && (
        <div className="space-y-6 auto-animate">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 oled:text-white emerald:text-emerald-100 space:text-zinc-100 nova:text-sky-100 transition-all-fast">Budget Management</h2>
          </div>
      ...
      {activeTab === "insights" && (
        <div className="space-y-6 auto-animate">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 oled:text-white emerald:text-emerald-100 space:text-zinc-100 nova:text-sky-100 transition-all-fast">Smart Insights</h2>
          </div>
